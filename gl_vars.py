...
class GL_container_class:
    ...
    def __init__(self):
        ...
        self.SIM_SEED = 5
        self.sim_time_tics = 20000                         # 1 tic equals 1 DL or UL interval in a frame

        # ------------------------Deployment configuration----------------------------
        self.carrier_frequency_Hz = 28e9
        self.bandwidth = 400e6
        self.cell_radius_m = 100
        self.n_UEs = 5
        self.n_IAB = 0
        ...
        self.FTP_parameter_lambda_UL = 0.1              # traffic intensity in UL
        ...
        self.traffic_type = 'FTP'                      # choose from 'FTP' or 'full'

        # ------------------------Scheduling and Optimization--------------------------------
        self.frame_division_policy = '50/50'              # available: '50/50', 'PF', 'OPT'
        ...
        # self.burst_size_bytes = 1.995 * 1e6        # file size for full-buffer traffic should be set
                                                        # to a large number, which will not be all transmitted;
                                                        # for FTP traffic, 1 Mbyte = 1e6 bytes is the standard value
        self.burst_size_bytes = 1053*2
